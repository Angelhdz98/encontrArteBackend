...
public class Obra {
	...
	public Obra(Long id, String titulo, String descripcion, int largo, int ancho, int precio, String certificado,
			String tecnica, String categoria, String imagen_obligatoria, String imagen2, String imagen3, String imagen4,
			String status, Long artista_id_artista) {
		this.id = id;
		this.titulo = titulo;
	...
	public void setArtista_id_artista(Long artista_id_artista) {
		...
		// genero toString usando source
	@Override
	public String toString() {
		return "ObraService [id=" + id + ", titulo=" + titulo + ", descripcion=" + descripcion + ", largo=" + largo
				+ ", ancho=" + ancho + ", precio=" + precio + ", certificado=" + certificado + ", tecnica=" + tecnica
				+ ", categoria=" + categoria + ", imagen_obligatoria=" + imagen_obligatoria + ", imagen2=" + imagen2
				+ ", imagen3=" + imagen3 + ", imagen4=" + imagen4 + ", status=" + status + ", artista_id_artista="
				+ artista_id_artista + "]";
	}
